Public Class FormEmplacements
    ...
    Public Sub New()
        ...
        ListeEmplacements = Bdd.GetEmplacements()
        ListeEmplacementsBind = New SortableBindingList(Of Emplacement)(ListeEmplacements)
        DataGridView1.DataSource = ListeEmplacementsBind

        PlanCimetiere1.AddListeEmplacements(ListeEmplacements)
    End Sub
