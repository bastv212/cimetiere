...
#End Region
    ...
    Sub poer()
        ...
        ' enregistrement défunt, à affiner/valider/...?
        Bdd.Add(LeDefunt)

        ' À FAIRE :
        ' emplacement choisi ? si oui, ajouter
        ' séjour ?

        ' ajouter le concessionnaire
        'If LeDemandeur.Nom <> "" AndAlso LeDemandeur.Prenom <> "" AndAlso
        '    Bdd.IdentifierActeur(LeDemandeur.Nom, LeDemandeur.Prenom) IsNot Nothing Then
        '    ' pareil que pour le concessionnaire
        'End If

        ' ajouter la  concession, mais seulement quand la demande a été traitée par le collège ?
