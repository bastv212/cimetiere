...
Public Class debug_tests
    ...
    Sub osef() Handles Me.Load
        ...
        PlanCimetiere1.AddListeEmplacements(empls)

        testdemgen.text = "FAITES QUELQUE CHOSE"
        testdemgen.AddChoix("bonjoazeazeazeijzaoiejazoeijazoijezaur", AddressOf dire_bonjour)
        testdemgen.AddChoix("bonjoazeazeazeijzaoiejazoeijazoijezaur", AddressOf dire_bonjour)
        'testdemgen.FlowPanelOptions.Controls.Add(New Label With {.Text = "osefsef"})
        testdemgen.AddChoix("bonjoazeazeazeijzaoiejazoeijazoijezaur", AddressOf dire_bonjour)
        testdemgen.AddChoix("bonjoazeazeazeijzaoiejazoeijazoijezaur", AddressOf dire_bonjour)
        testdemgen.AddChoix("bonjoazeazeazeijzaoiejazoeijazoijezaur", AddressOf dire_bonjour)
        testdemgen.AddChoix("bonjoazeazeazeijzaoiejazoeijazoijezaur", AddressOf dire_bonjour)
    ...
    Sub RemplirChampsAuto(selection As Object)
        Dim infos As Acteur = Bdd.Load(Of Acteur)(selection.Id)
        TbTestPrenom.Text = infos.Prenom
        TbTestNom.Text = infos.Nom
        TbTestAdr.Text = infos.Adresse & " " & If(infos.Cp, "") & " " & infos.Ville
    End Sub
